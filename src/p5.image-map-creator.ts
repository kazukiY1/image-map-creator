...
import { Area, AreaCircle, AreaEmpty, AreaPoly, AreaRect } from './class.area';
...
export class imageMapCreator {
  ...
  private mouseDragged(): void {
    if (this.mouseIsHoverSketch() && !ContextMenu.isOpen()) {
      ...
      } else if (this.p5.key == 't' || this.p5.mouseButton == this.p5.CENTER) {
